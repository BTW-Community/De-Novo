...
public class CactusWaterExtractionItem extends ProgressiveCraftingItem {
    public static final int TIME_TO_CRAFT = DEFAULT_MAX_DAMAGE;

    public CactusWaterExtractionItem(int itemID, String name) {
        super(itemID);
    ...
    private ItemStack getReturnStack() {
        return new ItemStack(DNItems.waterBowl);
    }
