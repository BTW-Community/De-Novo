...
public class EmiCharcoalWorldInteractionRecipe implements EmiRecipe {

    protected final ResourceLocation id;
    protected final List<EmiCharcoalWorldInteractionRecipe.WorldIngredient> left;
    protected final List<EmiCharcoalWorldInteractionRecipe.WorldIngredient> right;
    protected final List<EmiCharcoalWorldInteractionRecipe.WorldIngredient> outputIngredients;
    ...
    protected EmiCharcoalWorldInteractionRecipe(Builder builder) {
        this.id = builder.id;
    ...
    public static EmiCharcoalWorldInteractionRecipe.Builder builder() {
        return new EmiCharcoalWorldInteractionRecipe.Builder();
    }
...
//                int value = liquidSteps.get(index);
    ...
    public static class Builder {
        protected final List<EmiCharcoalWorldInteractionRecipe.WorldIngredient> left = Lists.newArrayList();
        protected final List<EmiCharcoalWorldInteractionRecipe.WorldIngredient> right = Lists.newArrayList();
        protected final List<EmiCharcoalWorldInteractionRecipe.WorldIngredient> output = Lists.newArrayList();
        ...
        public EmiCharcoalWorldInteractionRecipe build() {
            ...
            return new EmiCharcoalWorldInteractionRecipe(this);
        }

        public EmiCharcoalWorldInteractionRecipe.Builder id(ResourceLocation id) {
            this.id = id;
            return this;
        }

        public EmiCharcoalWorldInteractionRecipe.Builder leftInput(EmiIngredient stack) {
            this.left.add(new EmiCharcoalWorldInteractionRecipe.WorldIngredient(stack, false, s -> s));
            return this;
        }

        public EmiCharcoalWorldInteractionRecipe.Builder leftInput(EmiIngredient stack, Function<SlotWidget, SlotWidget> mutator) {
            this.left.add(new EmiCharcoalWorldInteractionRecipe.WorldIngredient(stack, false, mutator));
            return this;
        }

        public EmiCharcoalWorldInteractionRecipe.Builder rightInput(EmiIngredient stack, boolean catalyst) {
            this.right.add(new EmiCharcoalWorldInteractionRecipe.WorldIngredient(stack, catalyst, s -> s));
            return this;
        }

        public EmiCharcoalWorldInteractionRecipe.Builder rightInput(EmiIngredient stack, boolean catalyst, Function<SlotWidget, SlotWidget> mutator) {
            this.right.add(new EmiCharcoalWorldInteractionRecipe.WorldIngredient(stack, catalyst, mutator));
            return this;
        }

        public EmiCharcoalWorldInteractionRecipe.Builder output(EmiStack stack) {
            this.output.add(new EmiCharcoalWorldInteractionRecipe.WorldIngredient(stack, false, s -> s));
            return this;
        }

        public EmiCharcoalWorldInteractionRecipe.Builder output(EmiStack stack, Function<SlotWidget, SlotWidget> mutator) {
            this.output.add(new EmiCharcoalWorldInteractionRecipe.WorldIngredient(stack, false, mutator));
            return this;
        }

        public EmiCharcoalWorldInteractionRecipe.Builder supportsRecipeTree(boolean supportsRecipeTree) {
            this.supportsRecipeTree = supportsRecipeTree;
            return this;
        }

        public EmiCharcoalWorldInteractionRecipe.Builder animateOutputContents(int[] solidsteps) {
            if (solidsteps != null){
        ...
        public EmiCharcoalWorldInteractionRecipe.Builder setArrowToolTip(String s) {
            this.arrowToolTip = s;
            return this;
        }

        public EmiCharcoalWorldInteractionRecipe.Builder setRenderBack(boolean renderInputBack, boolean renderInput2Back,boolean renderOutputBack) {
        ...
        public EmiCharcoalWorldInteractionRecipe.Builder renderPlusOverlay(EmiTexture emiTexture) {
