...
public class EmiRainStack extends EmiStack {
    ...
    private static final ResourceLocation RAIN_TEXTURE = new ResourceLocation("denovo", "textures/emi/rain.png");
    ...
    public List<Text> getTooltipText() {
        return List.of(Text.translatable("emi.denovo.rain.desc"));
    }

    @Override
    public List<TooltipComponent> getTooltip() {
        List<TooltipComponent> list = new ArrayList<>();
        list.add(TooltipComponent.of(Text.translatable("emi.denovo.rain")));
    ...
    @Override
    public Text getName() {
        return Text.translatable("emi.denovo.rain");
    }
