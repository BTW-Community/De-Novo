...
public class EmiCustomWorldInteractionRecipe implements EmiRecipe {
    ...
    private final List<Integer> liquidSteps;
    private final List<Integer> solidSteps;
    private final boolean supportsRecipeTree;
    private final int slotHeight;
    private final String arrowToolTip;
    ...
    private boolean renderInputBack;
    private boolean renderInput2Back;
    private boolean renderOutputBack;
...
//                int value = liquidSteps.get(index);
    ...
    public static class Builder {
        ...
        private final List<Integer> liquidSteps = Lists.newArrayList();
        private final List<Integer> solidSteps = Lists.newArrayList();
        public boolean renderInputBack;
        public boolean renderInput2Back;
        public boolean renderOutputBack;
