...
public class SmolderingPlacedSticksBlock extends BlockContainer {
    ...
    public SmolderingPlacedSticksBlock(int iBlockID) {
        ...
        setUnlocalizedName("denovo.smoldering_placed_sticks");
    }
...
/*        SmolderingPlacedSticksTileEntity tileEntity = (SmolderingPlacedSticksTileEntity) world.getBlockTileEntity(i,j,k);
    ...
    public void registerIcons(IconRegister register) {
        top[0] = register.registerIcon("denovo:smoldering_placed_shafts_top_0");
        top[1] = register.registerIcon("denovo:smoldering_placed_shafts_top_1");
        top[2] = register.registerIcon("denovo:smoldering_placed_shafts_top_2");
        top[3] = register.registerIcon("denovo:smoldering_placed_shafts_top_3");

        top_alt[0] = register.registerIcon("denovo:smoldering_placed_shafts_top_alt_0");
        top_alt[1] = register.registerIcon("denovo:smoldering_placed_shafts_top_alt_1");
        top_alt[2] = register.registerIcon("denovo:smoldering_placed_shafts_top_alt_2");
        top_alt[3] = register.registerIcon("denovo:smoldering_placed_shafts_top_alt_3");

        side[0] = register.registerIcon("denovo:smoldering_placed_shafts_side");
        side[1] = register.registerIcon("denovo:smoldering_placed_shafts_side_alt");

        blockIcon = side[0];
        iconEmbers = register.registerIcon("denovo:smoldering_placed_shafts_overlay");
    }
