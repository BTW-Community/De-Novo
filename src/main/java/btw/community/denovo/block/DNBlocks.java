...
public class DNBlocks {
    ...
    public static void initBlocks() {
        ...
        TileEntity.addMapping(SieveTileEntity.class, "DNBlockSieve");

        composter = registerItemBlock(new ComposterBlock(DeNovoAddon.instance.parseID("DNBlockComposterID")));
        TileEntity.addMapping(ComposterTileEntity.class, "DNBlockComposter");

        cistern = new CisternBlock(DeNovoAddon.instance.parseID("DNBlockCisternID"));
        TileEntity.addMapping(CisternTileEntity.class, "DNBlockCistern");
        ...
        TileEntity.addMapping(SmolderingPlacedSticksTileEntity.class, "DNBlockSmolderingPlacedSticks");
